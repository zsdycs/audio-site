...
exports.Order = mongolass.model('Ordre', {
  userId: { type: Mongolass.Types.ObjectId, require: true},
  audioId: { type: Mongolass.Types.ObjectId, required: true },
  name: { type: 'string', required: true },
  price: { type: 'string', required: true },
  license: { type: 'string', required: true },
})
exports.Order.index({audioId: 1,userId: 1,license: 1},{ unique: true }).exec()
...
exports.AudioList = mongolass.model('Audio', {
  _id: { type: Mongolass.Types.ObjectId, required: true },
